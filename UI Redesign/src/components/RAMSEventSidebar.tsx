...
import { Radio, Search, ShieldAlert, Activity, Battery, MapPin } from 'lucide-react';
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between gap-2 mb-2">
                  ...
                  <span className={`px-2 py-0.5 rounded text-[9px] font-mono font-bold uppercase tracking-wider border flex-shrink-0 ${getBadgeClass(event.type)}`}>
                    {statusLabel}
                  </span>
                </div>
