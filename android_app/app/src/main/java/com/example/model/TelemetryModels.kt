...
data class DeviceLinkStatus(
  ...
  val deviceToken: String = "RAMS-NODE-8821",
  val firmwareVersion: String = "v2.4.1-WEARABLE-IMU-GNSS",
  val ipAddress: String = "192.168.4.1",
  val port: Int = 8080,
  val wsUrl: String = "ws://192.168.4.1:81/ws",
  val bluetoothName: String = "RAMS Bluetooth Connection",
...
data class IncidentEvent(
  ...
  val locationAddress: String = "Maharlika Highway cor. Caritan Norte, Tuguegarao City",
  val formFactor: String = "Belt Clip-On Wearable (RAMS 6-DOF + GNSS)",
  val firmware: String = "v2.4.1-Uplink (AES-128)",
  val notes: String = ""
) {
